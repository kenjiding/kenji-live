      ...
      <div className='grid grid-cols-4 gap-4 place-items-center'>
        {recommendList.map((item, index) => (
          ...
          >
            ...
            <div className='relative inset-0 bg-white/20 backdrop-blur-md w-full h-full flex justify-center group'>
              <Image
                alt='gift'
                width={150}
                height={150}
              ...
              <div className='hidden group-hover:flex bg-black opacity-60 absolute top-0 left-0 w-full h-full justify-center items-center'>
                <Play size={30} />
              </div>
            </div>
